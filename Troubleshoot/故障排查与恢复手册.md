...
3. 尝试ping www.baidu.com，验证网络是否正常

3. 输入docker ps 、 kubectl get nodes 、kubectl get pods -A 是否正常

   ![f46b80f6-1e1d-4a74-9eb0-943b6151b278](scrennshot/f46b80f6-1e1d-4a74-9eb0-943b6151b278.png)

   - 若不正常，重启master01节点上的docker和kubelet
...
# 关于异常现象3 kube-proxy 在 cluster-info cm 更新后需要重建才能生效；查看 kube-proxy pod 的日志时发现还有旧IP存在
